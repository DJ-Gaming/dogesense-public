...
void render::initialize() {
	...
	interfaces::surface->set_font_glyph(render::fonts::esp_font, "Small Fonts", 12, 400, 0, 0, font_flags::fontflag_outline);
	interfaces::surface->set_font_glyph(render::fonts::velocity_font, "Tahoma", 24, 800, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::Visitor9, "Visitor TT2 BRK", 9, 400, 0, 0, font_flags::fontflag_outline);
	interfaces::surface->set_font_glyph(render::fonts::TahomaBold12, "Tahoma Bold", 12, 400, 0, 0, font_flags::fontflag_dropshadow);
